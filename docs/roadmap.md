...
- agent registration and scoped grants;
- user confirmation and revocation lifecycle;
- privacy-safe local shopping CSV extraction;
...
- versioned OpenAPI document generated from the hosted gateway;
...
- production x402 settlement adapters across supported rails;
